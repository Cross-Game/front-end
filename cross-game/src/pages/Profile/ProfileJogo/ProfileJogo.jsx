        ...
        return (
            <>
                ...
                {showModalAdicionarPerfilJogo && (
                    <Modal title="Perfil de Jogo" icon={<RiFileEditFill />} temFooter={true} ativarBotao={true} textButton="Cadastrar" iconButton={<BsCheck />} onClose={()=> setShowModalAdicionarPerfilJogo(false)}>
